...
namespace ProcessorDispatcher
{
    ...
    public interface IDispatcher
    {
        ...
        /// </summary>
        event Action<IDispatcherItem, SimulationStepSize, int, AluCmd, IReadOnlyDictionary<byte, byte>, IReadOnlyDictionary<Registers, IRegister>, bool[]> FinishedStep;
        ...
        /// <summary>
        /// Event, which is fired, when the history stack is empty.
        /// </summary>
        event Action<IDispatcherItem> HistoryStackEmpty;
       ...
       /// <summary>
       /// Queue an undo step request for the <see cref="IProcessor"/> with the given id.
       /// </summary>
       /// <param name="id"></param>
       /// <param name="stepSize"></param>
        void UndoStep(Guid id, SimulationStepSize stepSize);
