...
namespace Stebs5.Tests
{
    ...
    public class ProcessorTestUtility
    {
        ...
        {
            RegisterFactory = (type, data, highlight) => new Register(type, data, highlight);
        ...
        /// <param name="value"></param>
        public void SetRegister(Registers type, uint value, bool highlight) => Processor.Execute(session => session.SetRegister(type, value, highlight));
