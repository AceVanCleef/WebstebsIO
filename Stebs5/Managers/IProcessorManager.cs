...
namespace Stebs5
{
    ...
    public interface IProcessorManager
    {
        ...
        /// <summary>
        /// Create breakpoints on the server.
        /// </summary>
        /// <param name="clientId"></param>
        /// <param name="breakpointArray"></param>
        void CreateBreakpoints(string clientId, int[] breakpointArray);
        ...
        /// <summary>
        /// Execute an undo step with the given size on the processor of the given client id.
        /// </summary>
        /// <param name="clientId"></param>
        /// <param name="stepSize"></param>
        void UndoStep(string clientId, SimulationStepSize stepSize = SimulationStepSize.Instruction);
        ...
        /// <param name="clientId"></param>
        /// <param name="stepSize"></param>
        void ChangeStepSize(string clientId, SimulationStepSize stepSize);
        ...
        /// <param name="slot">Device slot in the processor.</param>
        /// <param name="input">Update information.</param>
        /// <param name="secondinput">second Update information.</param>
        void UpdateDevice(string clientId, byte slot, string input, string secondInput);
        ...
        /// </summary>
        /// <param name="clientId"></param>
        void HardwareInterrupt(string clientId);
    }
}
