...
namespace ProcessorSimulation
{
    ...
    public class StatusRegister
    {
        ...
        private StatusRegister SetBit(bool flag, uint bit, RegisterFactory registerFactory) => new StatusRegister(registerFactory(Registers.Status, flag ? (Value | bit) : (Value & ~bit), false));
